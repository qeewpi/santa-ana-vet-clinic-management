          ...
          <div className="benefit">
            ...
            <div className=" mb-4 bg-white rounded-2xl p-10">
              <p className="text-gray-700 text-base font-semibold leading-relaxed">
                ...
                sessions, and dog walking services – all in one place, anytime.
              </p>
            </div>
          </div>
          <div className="benefit">
            ...
            <div className=" mb-4 bg-white rounded-2xl p-10">
              <p className="text-gray-700 text-base font-semibold leading-relaxed">
                Secure Access to Pet Records: Keep track of your pet's
                vaccination history, medications, and medical notes – all
